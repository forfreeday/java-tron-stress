...
# sh manual_send.sh 1000 /tmp/testAllTransaction/getTransactions.txt_10000_1212888 0 303222
...
runJavaTronStress() {
  ...
  // demo: -Dqps=10000 -DfilePath=getTransactions.txt_10000_1212888 -DstartBlock=100 -DendBlock=299999 -DfullNode=2
