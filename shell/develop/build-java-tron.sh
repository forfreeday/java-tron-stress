...
modifyConsensus(){
  cp /$WORK_PATH/StatisticManager.java $JAVA_TRON/java-tron/consensus/src/main/java/org/tron/consensus/dpos/StatisticManager.java
  cp /$WORK_PATH/StateManager.java $JAVA_TRON/java-tron/consensus/src/main/java/org/tron/consensus/dpos/StateManager.java
  cp /$WORK_PATH/DposService.java $JAVA_TRON/java-tron/consensus/src/main/java/org/tron/consensus/dpos/DposService.java
}
