...
/data/databackup/java-tron/java-tron-1.0.0/bin/FullNode -c /data/databackup/java-tron/config.conf > /data/databackup/java-tron/tron-shell.log 2>&1 & echo $! >/data/databackup/java-tron/pid.txt
